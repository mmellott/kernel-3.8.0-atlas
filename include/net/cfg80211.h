...
struct state_survey {
    int frame_ack_good_count;
    int frame_ack_bad_count;
    u32 ratio_busy_scale;
    struct timespec diff_time;
    int read;
};

int atlas_algorithm(struct atlas_header *atlas_header_point, int tx_rx, u8 * src, struct sk_buff *skb, int depth_queue, struct state_survey *current_survey);
